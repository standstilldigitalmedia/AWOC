@tool
class_name AWOCPreviewControlBase 
...
func create_down_button() -> Button:
	...
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "ArrowDown.svg")
...
func create_left_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "ArrowLeft.svg")
...
func create_movement_button() -> Button:
	...
	button.custom_minimum_size = Vector2(31,31)
...
func create_reset_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "CenterView.svg")
...
func create_right_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "ArrowRight.svg")
...
func create_rotate_left_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "RotateLeft.svg")
...
func create_rotate_right_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "RotateRight.svg")
...
func create_up_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "ArrowUp.svg")
...
func create_zoom_in_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "Add.svg")
...
func create_zoom_out_button() -> Button:
	var button: Button = create_movement_button()
	button.icon = preload(AWOCGlobal.ICON_BASE_DIRECTORY + "CurveConstant.svg")
